...
const Card = ({ product, addToCart }) => {
  ...
  return (
    <div className="relative m-10 flex w-[350px] lg:h-[400px] max-w-xs justify-between flex-col overflow-hidden rounded-lg border border-gray-100 bg-black shadow-md cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-[0px_0px_15px_rgba(0,255,255,0.7)]">
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <button 
          ...
          className={`flex items-center justify-center rounded-md ${isAddedToCart ? 'bg-gray-900 cursor-not-allowed' : 'bg-slate-500 hover:bg-gray-800'} px-20 py-2.5 text-center text-sm font-medium text-white`}
        >
